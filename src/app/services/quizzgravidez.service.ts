  ...
  getQuizzGravidez(){
    ...
    },
    {
      ...
      respostas:[{
        ...
        descricao: `Saiba quando você pode fazer um teste de gravidez.`        
      },
      {
        id: 2.2,
        texto: `Em alguns dias`,
        descricao: `Você não precisa esperar por um atraso do período menstrual antes de fazer um teste de gravidez. `        
      },
      {
        id: 2.3,
